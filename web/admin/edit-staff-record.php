...
if (isset($_POST['submit'])) {
    ...
    $pincode = trim($_POST['pincode']);
     ...
     $year_of_exp = trim($_POST['year_of_exp']);     
        ...
        $stmt = $conn->prepare("update staff_record set full_name=?,father_name=?,date_of_join=?,date_of_birth=?,blood_group=?,cast=?,pincode=?,address=?,state=?,mobile=?,email=?,password=?,photo=?,study=?,university=?,pass_out=?,staff_id=?,gender=?,basic_salary=?,religion=?,country=?,physical_status=?,institute_name=?,percentage=?,marksheet_no=?,year_of_exp=?,user_id=?,date=? where school_id=?");

        $stmt->bind_param("sssssssssssssssssssssssssssss", $full_name,$father_name,$date_of_join, $date_of_birth,$blood_group, $cast,$pincode,$address,$state,$mobile,$email,$password,$photo,$study,$university,$pass_out,$staff_id,$gender,$basic_salary,$religion,$country,$physical_status,$institute_name,$percentage,$marksheet_no,$year_of_exp,$user_id,$date,$school_id);
        ...
        if (trim($file_name) != "") {
            ...
            $query = "update staff_record set photo = '" . $file_name . "' where id=$id";
    ...
    $sql = "select * from staff_record where school_id=$school_id";
                  ...
                  <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h1 class="panel-title">Edit Principal</h1>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label for="staff_name" class="control-label required">Staff Name</label>

                                            <input value="<?php echo $row['full_name']; ?>" required="required" maxlength="50" type="text"

                                                   name="full_name" class="form-control" placeholder="Staff Name">
...
<div class="input-group">
						...
						<span class="input-group-btn"><button type="button" class="btn btn-primary" data-toggle="datepicker"><i class="fa fa-calendar"></i></button></span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $row['pincode']; ?>" required="required" 

                                                   maxlength="6" pattern="[0-9]{6,6}" name="pincode" class="form-control" placeholder="pincode ">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $row['mobile']; ?>" required="required"  maxlength="10" pattern="[0-9]{10,10}"
                                        ...
                                        <div class="form-group">
										 ...
										 <div class="form-group">
                                            ...
                                            <input value="<?php echo $row['password']; ?>" required="required" maxlength="50" type="password"
                                ...
                                <div class="col-md-6">
								 ...
								 <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="staff" class="control-label required">Staff Id</label>

                                            <input value="<?php echo $row['staff_id']; ?>" required="required" type="text" maxlength="200"

                                                   name="staff_id" id="staff_id" class="form-control"
