...
if (isset($_POST['submit'])) {
	...
	$total_mark = trim($_POST['total_mark']);
		 ...
		 $stmt = $conn->prepare("update exam_schedule set class_id=?,subject_id=?,exam_date=?,exam_time=?,description=?,pass_mark=?,total_mark=?,user_id=?,date=? where id=?"); 
        $stmt->bind_param("ssssssssss",$class_id,$subject_id,$exam_date,$exam_time,$description,$pass_mark,$total_mark,$user_id,$date,$id);
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="class_id" class="form-control" required="required" >
                                                ...
                                                while ($row2 = mysqli_fetch_assoc($result2)) {
                                                    ?>
                                                    <option value="<?php echo $row2['id']; ?>" <?php if ($row['class_id'] == $row2['id']) echo " selected "; ?> ><?php echo $row2['class_name']; ?></option>
												<?php }?>
                                          </select>
                                        </div>
										 ...
										 <div class="form-group">
                                            ...
                                            <select name="subject_id" class="form-control" required="required" >
                                                ...
                                                while ($row2 = mysqli_fetch_assoc($result2)) {
                                                    ?>
                                                    <option value="<?php echo $row2['id']; ?>" <?php if ($row['subject_id'] == $row2['id']) echo " selected "; ?>><?php echo $row2['sub_name']; ?></option>
												<?php }?>
												</select>
										...
										<div class="form-group">
                                            ...
                                            <input value="<?php echo $row['total_mark']; ?>" maxlength="50" type="text"
										...
										<div class="form-group">
                                            ...
                                            <input value="<?php echo $row['description']; ?>" maxlength="50" type="text"
