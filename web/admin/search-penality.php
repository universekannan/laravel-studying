...
session_start();
    ...
    $sql = "SELECT * FROM issue_book" . $queryCondition;
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <div>      
            <form name="frmSearch" method="post" action="search-penality.php">
            ...
            <div>
				...
				<!--<?php //$sql1 = "SELECT a.*,b.standard,section_name,c.full_name FROM issue_book a,class b,users c where a.class_id=b.id and a.school_id=c.school_id";
   // $result1 = mysqli_query($conn, $sql1);  
                       // if ($row1 = mysqli_fetch_assoc($result1)) {
                            ?>-->
 
				<tr>
                <td><div><strong><?php echo $row["school_id"]; ?></strong></div></td>
               <td> <div class="result-description"><?php echo $row["class_id"]; ?></div></td>
               <td> <div class="result-description"><?php echo $row["book_id"]; ?></div></td>
               <td> <div class="result-description"><?php echo $row["book_name"]; ?></div></td>
               <td> <div class="result-description"><?php echo $row["author_name"]; ?></div></td>
               <td> <div class="result-description"><?php echo $row["date"]; ?></div></td>
               <td> <div class="result-description"><?php echo $row["return_date"]; ?></div></td>
               <td>  <a href="add-penality.php?id=<?php echo $row['id']; ?>" class="btn btn-info">Add Penality</a></td>
