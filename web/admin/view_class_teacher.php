...
session_start();
$page = "Assign";
$page1 = "View Assign Class Teacher";
include "timeout.php";
include "config.php";
    ...
    <section class="content">
      <div class="row">
       ...
       <div class="box-header">
             <center> <h3>Assign Staff List</h3> </center>
           <hr>
            </div>
   <div class="box-body">
			    ...
			    <th>Status</th>
                        ...
                        if(($_SESSION['user_type']=="admin") ||($_SESSION['user_type']=="principal")){
                            $sql = "select a.*,b.full_name,c.id,standard,section_name from assign_staff a,users b,class c where a.staff_id=b.id and a.class_id=c.id";
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr> 
                                ...
                                <td>
                               <a class="btn btn-info fa fa-trash-o" href="delete_assign.php?id=<?php echo $row['id']; ?>"></a></td>
                            </tr>
                        <?php
