...
<div class="wrapper">
 ...
 <br /> 
       ...
       <div class="box-header">
             <center> <h3 class="box-title">Issue Books...</h3> </center>
            </div>
                    ...
                    <thead>
                        ...
                        <?php
                         if($_SESSION['user_type']=="admin"){
                           $sql = "select a.*,b.section_name,standard,c.full_name from issue_book a,class b,student_record c where a.class_id=b.id and  a.school_id=c.school_id and a.status='Inactive'";
                        }
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td><?php echo $row['full_name']; ?></td>
                                ...
                                <td><a class="btn btn-info fa fa-edit" href="edit-issue-book.php?id=<?php echo $row['id']; ?>"></a>
                                <a class="btn btn-info fa fa-trash-o" href="delete-issue-book.php?id=<?php echo $row['id']; ?>"></a></td>
                            </tr>
                        <?php
