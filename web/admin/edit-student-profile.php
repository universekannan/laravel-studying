...
<div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input value="<?php echo $row['full_name']; ?>" required="required" type="text" maxlength="20"
...
<div class="input-group">
		 ...
		 <div class="form-group">
            ...
            <input value="<?php echo $row['email']; ?>" required="required" type="text" maxlength="20"
		...
		<div class="form-group">
		 ...
		 <div class="form-group">
            ...
            <input value="<?php echo $row['mobile']; ?>" required="required" type="text" maxlength="20"
