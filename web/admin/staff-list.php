 ...
 <br /> 
   ...
   <div class="box-body">
                    ...
                    <thead>
                        ...
                        $sql = "select * from staff_record where  id=$user_id";
                    }
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
							...
							<td>
                                ...
                                <td><a class="btn btn-info fa fa-calendar" title="Attendance Report" href="view-staff-attendance.php?id=<?php echo $row['id']; ?>"></a>
