       ...
       <div class="box-header">
	    <?php
                        ...
                        if ($row = mysqli_fetch_assoc($result)) {
                            ?>
             <center> <h3 class="box-title">CLASS&nbsp;(<?php echo $row['standard']; ?>  <?php echo $row['section_name']; ?>)</h3> </center>
			  <?php
   ...
   <div class="box-body">
                    ...
                    <thead>
                        ...
                        if($_SESSION['user_type']=="admin"){
                             $sql = "select a.*,b.fees_name,c.balance,paid_amount from fees_detail a,fees b,pay c where  a.fees_id=b.id and a.class_id=c.class_id";
                        }
                          ...
                          //$sql = "select a.*,b.fees_name,c.balance,paid_amount from fees_detail a,fees b,pay c where  a.fees_id=b.id and a.class_id=c.class_id";
						  $sql = "select a.*,b.standard,section_name,c.fees_name,d.full_name from fees_detail a,class b,fees c,users d where a.class_id=b.id and a.fees_id=c.id  group by fees_id";
                        }
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <a class="btn btn-info fa fa-inr" title="Pay Amount" href="pay-fees.php?id=<?php echo $row['fees_id']; ?>"></a>
								<?php } ?>
								<?php if(($_SESSION['user_type']=="admin") || ($_SESSION['user_type']=="staff")){ ?>
							   <a class="btn btn-info fa fa-eye" title="View Amount" href="view-pay-fees.php?id=<?php echo $row['fees_id']; ?>"></a>
								<?php } ?>
                                </td>
                            </tr>
                        <?php
