...
if (isset($_POST['submit'])) {
	...
	$stmt = $conn->prepare("INSERT INTO principal_record(school_id,full_name,email,status,password,mobile,address,photo) VALUES (?,?,?,?,?,?,?,?)");
 					 ...
 					 <div class="form-group">
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea maxlength="200" rows='5' name="address" class="form-control"
