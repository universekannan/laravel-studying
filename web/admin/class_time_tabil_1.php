...
if (isset($_POST['submit'])) {
    ...
    $pried_1 = trim($_POST['pried_1']);
    $subject_1 = trim($_POST['subject_1']);

        $stmt = $conn->prepare("INSERT INTO staff_time_table (day_id,class_id,staff_id,pried_1,subject_1) VALUES (?,?,?,?,?)");
        $stmt->bind_param("sssss",$day_id, $class_id, $staff_id=$staff_id, $pried_1,$subject_1);
