                    ...
                    <thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr> 
                                ...
                                <td style="text-align:center"><a class="btn btn-info fa fa-pencil" href="edit-examname.php?id=<?php echo $row['id']; ?>"></a>
                                <a class="btn btn-info fa fa-trash-o" href="delete-examname.php?id=<?php echo $row['id']; ?>"></a></td>
                            </tr>
                        <?php
