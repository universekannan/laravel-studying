            ...
            <div class="panel-group panel-dark" id="accordion">
			      <?php
                         if($_SESSION['user_type']=="admin"){
                          $sql = "select a.*,b.exam_name,c.sub_name from student_marklist a,exam b,subject,c where a.exam_id=b.id and a.subject_id=c.id group by a.exam_id";
                        }
                          ...
                          $sql = "select a.*,b.section_name,standard,c.sub_name,d.full_name,e.exam_name from student_marklist a,class b,subject c,student_record d,exam e where a.class_id=b.id and a.subject_id=c.id  and a.exam_id=e.id and a.school_id=d.school_id group by a.exam_id";
                        }
                      else if($_SESSION['user_type']=="student"){
                        //$sql = "select a.*,b.exam_name from student_marklist a,exam b where a.exam_name=b.id and a.stu_id=$stu_id group by a.exam_name";
                        //$sql = "select * from student_marklist where user_id=$user_id and id=$stu_id";
