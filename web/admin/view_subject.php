    ...
    <section class="content">
      <div class="row">
       ...
       <div class="box-header">
             <center> <h3>Subject List</h3> </center>
           <hr>
            </div>
   <div class="box-body">
                    ...
                    <thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr> 
                                ...
                                <td><a class="btn btn-info fa fa-edit" href="edit_subject.php?id=<?php echo $row['id']; ?>"></a>
                                <a class="btn btn-info fa fa-trash-o" href="delete_subject.php?id=<?php echo $row['id']; ?>"></a></td>
                            </tr>
                        <?php
