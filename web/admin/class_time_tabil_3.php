...
if (isset($_POST['submit'])) {
    ...
    $pried_3 = trim($_POST['pried_3']);
    $subject_3 = trim($_POST['subject_3']);

        $stmt = $conn->prepare("INSERT INTO staff_time_table (day_id,class_id,staff_id,pried_3,subject_3) VALUES (?,?,?,?,?)");
        $stmt->bind_param("sssss",$day_id, $class_id, $staff_id=$staff_id, $pried_3,$subject_3);
...
width: 105px;
 ...
 <td>
								<div class="form-group">
										...
										<td>
                               <div class="form-group">
                                            <label for="pried_3 required"
                                                   class="control-label required">Pried 1</label>
                                            <select name="pried_3" class="form-control" required="required" >
                                                <option value="">-----Select------</option>
                             ...
                             <td>
								<div class="form-group">
                                            <label for="subject_3 required"
                                                   class="control-label required">Subject</label>
                                            <select name="subject_3" class="form-control" required="required" >
                                                <option value="">-----Select------</option>
