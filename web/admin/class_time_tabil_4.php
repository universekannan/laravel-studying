...
if (isset($_POST['submit'])) {
    ...
    $pried_4 = trim($_POST['pried_4']);
    $subject_4 = trim($_POST['subject_4']);

        $stmt = $conn->prepare("INSERT INTO staff_time_table (day_id,class_id,staff_id,pried_4,subject_4) VALUES (?,?,?,?,?)");
        $stmt->bind_param("sssss",$day_id, $class_id, $staff_id=$staff_id, $pried_4,$subject_4);
...
width: 105px;
 ...
 <td>
								<div class="form-group">
										...
										<td>
                               <div class="form-group">
                                            <label for="pried_4 required"
                                                   class="control-label required">Pried 1</label>
                                            <select name="pried_4" class="form-control" required="required" >
                                                <option value="">-----Select------</option>
                             ...
                             <td>
								<div class="form-group">
                                            <label for="subject_4 required"
                                                   class="control-label required">Subject</label>
                                            <select name="subject_4" class="form-control" required="required" >
                                                <option value="">-----Select------</option>
													<option value="Leisure Time">Leisure Time</option>
													<?php
