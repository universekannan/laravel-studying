...
if (isset($_POST['submit'])) {
    ...
    $fees_name = trim($_POST['fees_name']);
        ...
        $stmt = $conn->prepare("UPDATE fees  set fees_name=?,user_id=?,date=? where id=?");
        $stmt->bind_param("ssss",$fees_name, $user_id,$date,$id);
        $stmt->execute();
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="fees_name required"
                                                       class="control-label required">Fess Name</label>
                                                <input value="<?php echo $row['fees_name']; ?>" required="required" type="text"
                                                       maxlength="50"
