...
<div class="wrapper">
 ...
 <br /> 
       ...
       <div class="box-header">
             <center> <h3>All Students Records..</h3> </center>
            <hr>
            </div>
   <div class="box-body">
			...
			// $sql = "select * from user where id in(select school_id from assign_staff where user_id=$user_id)";
                      }
                      else if($_SESSION['user_type']=="student"){
                        $sql = "select * from student_record where user_id=$user_id";
                    }
