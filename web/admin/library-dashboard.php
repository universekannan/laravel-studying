        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content no-padding">
              <!-- Morris chart - Sales -->
              <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 170px;"></div>
              <div class="chart tab-pane" id="sales-chart" style="position: relative; height: 170px;"></div>
            </div>
          </div>
          <!-- /.nav-tabs-custom -->
