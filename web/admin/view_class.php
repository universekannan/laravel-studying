                    ...
                    <thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr> 
                                ...
                                <!--<a class="btn btn-info fa fa-edit" href="edit_class.php?id=<?php echo $row['id']; ?>"></a></td>-->
                                <td><a class="btn btn-info fa fa-trash-o" href="delete_class.php?id=<?php echo $row['id']; ?>"></a></td>
                            </tr>
                        <?php
