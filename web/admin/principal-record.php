...
<div class="wrapper">
 ...
 <br /> 
       ...
       <div class="box-header">
             <center> <h3>Principal Details...</h3> </center>
           <hr>
            </div>
   <div class="box-body">
                    ...
                    <thead>
                        ...
                        if($_SESSION['user_type']=="admin"){
                            $sql = "select * from users where user_type='principal'";
                        }
                        else if($_SESSION['user_type']=="principal"){
                          $sql = "select * from users where user_type='principal' and id=$user_id";
                      }
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
							...
							<td>
                              ...
                              <!--  <td><?php echo nl2br($row['address']); ?></td>-->
                                ...
                                <td><a class="btn btn-info fa fa-edit" href="edit-principal-login.php?id=<?php echo $row['id']; ?>"></a>
                                </td>
                            </tr>
                        <?php
