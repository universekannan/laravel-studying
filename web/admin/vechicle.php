    ...
    <section class="content">
      <div class="row">
       ...
       <div class="box-header">
             <center> <h3>Vechicle List</h3> </center>
			 <hr>
            </div>
   <div class="box-body">
                    ...
                    <thead>
                         <tr style="background-color: #2a6b90;color:white">
                            <th>Vechicle No</th>
                            <th>Vechicle Name</th>
                            <th width="60px" style="text-align:right">Action</th>
                                        </tr>
                                    </thead>
                                       <tbody>
                        <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr> 
								 ...
								 <td><?php echo $row['vechicle_name']; ?></td>
                                <td><a class="btn btn-info fa fa-edit" href="edit-vechicle.php?id=<?php echo $row['id']; ?>"></a>
                                <a class="btn btn-info fa fa-trash-o" href="delete-vechicle.php?id=<?php echo $row['id']; ?>"></a></td>
                            </tr>
                        <?php
