...
if (isset($_POST['submit'])) {
    ...
    $exam_name = trim($_POST['exam_name']);
        ...
        $stmt = $conn->prepare("UPDATE exam  set exam_name=?,user_id=?,date=? where id=?");
        $stmt->bind_param("ssss",$exam_name, $user_id,$date,$id);
        $stmt->execute();
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="exam_name required"
                                                       class="control-label required">Exam Name</label>
                                                <input value="<?php echo $row['exam_name']; ?>" required="required" type="text"
                                                       maxlength="50"
                                                       name="exam_name" id="exam_name" class="form-control"
