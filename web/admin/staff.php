...
<div class="wrapper">
 ...
 <br /> 
       ...
       <div class="box-header">
             <center> <h3 class="box-title">Staff Details...</h3> </center>
            </div>
                    ...
                    <thead>
                        ...
                        $sql = "select * from users where user_type='staff' and id=$user_id";
                    }
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
							...
							<td>
                                ...
                                <td><a class="btn btn-info fa fa-edit" href="edit-staff-login.php?id=<?php echo $row['id']; ?>"></a>
