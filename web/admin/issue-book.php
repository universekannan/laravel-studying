                    ...
                    <thead>
                        ...
                        <?php
                         if($_SESSION['user_type']=="admin"){
                           $sql = "select a.*,b.section_name,standard,c.full_name from issue_book a,class b,student_record c where a.class_id=b.id and  a.school_id=c.school_id and a.status='Active'";
                        }
